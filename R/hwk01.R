...
ggsave(filename = 'hwk/hwk01/img/q01_lowess.png')
...
ggplot(data = cm, mapping = aes(x = copiers, y = minutes)) +
  ...
  labs(x = 'Copiers', y = 'Minutes') +
  theme_minimal(base_size = 40)
ggsave(filename = 'hwk/hwk01/img/q01_linear.png')
...
ggplot(data = sen, mapping = aes(x = Risk, y = Stay)) +
  ...
  theme_minimal(base_size = 40)
ggsave(filename = 'hwk/hwk01/img/q02_loess1.png')
...
ggplot(data = sen, mapping = aes(x = AFS, y = Stay)) +
  ...
  theme_minimal(base_size = 40)
ggsave(filename = 'hwk/hwk01/img/q02_loess2.png')
...
ggplot(data = sen, mapping = aes(x = Xray, y = Stay)) +
  ...
  theme_minimal(base_size = 40)
ggsave(filename = 'hwk/hwk01/img/q02_loess3.png')
...
ggplot(data = sen, mapping = aes(x = Risk, y = Stay)) +
  ...
  labs(x = 'Patient Risk', y = 'Average Stay') +
  theme_minimal(base_size = 40)
ggsave(filename = 'hwk/hwk01/img/q02_lm1.png')
...
ggplot(data = sen, mapping = aes(x = AFS, y = Stay)) +
  ...
  labs(x = 'Available Services', y = 'Average Stay') +
  theme_minimal(base_size = 40)
ggsave(filename = 'hwk/hwk01/img/q02_lm2.png')
...
ggplot(data = sen, mapping = aes(x = Xray, y = Stay)) +
  ...
  labs(x = 'X-ray Ratio', y = 'Average Stay') +
  theme_minimal(base_size = 40)
ggsave(filename = 'hwk/hwk01/img/q02_lm3.png')
